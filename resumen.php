  ...
  function fnViveMovimento_resumen_data(){
	...
	function fnViveMovimento_resumen_init(){
      ...
      if (isset($_GET['action']) && $_GET['action'] == 'dashboard' && isset($_POST['intOpcion']) && $_POST['intOpcion'] != null && $_POST['intOpcion'] == '1') {
        ...
        $wpdb->get_results("UPDATE wp_vivemov_pasos_videos as D SET D.strURL = '$strURL_paso_1' WHERE D.decId = 1");
        $wpdb->get_results("UPDATE wp_vivemov_pasos_videos as D SET D.strURL = '$strURL_paso_2' WHERE D.decId = 2");
        $wpdb->get_results("UPDATE wp_vivemov_pasos_videos as D SET D.strURL = '$strURL_paso_3' WHERE D.decId = 3");
        $wpdb->get_results("UPDATE wp_vivemov_pasos_videos as D SET D.strURL = '$strURL_paso_4' WHERE D.decId = 4");
        $wpdb->get_results("UPDATE wp_vivemov_pasos_videos as D SET D.strURL = '$strURL_paso_5' WHERE D.decId = 5");
        $wpdb->get_results("UPDATE wp_vivemov_pasos_videos as D SET D.strURL = '$strURL_paso_6' WHERE D.decId = 6");
        $wpdb->get_results("UPDATE wp_vivemov_pasos_videos as D SET D.strURL = '$strURL_paso_7' WHERE D.decId = 7");
      }
    ...
    <div class="alert alert-<?php echo ($gDataPaso_1 == null ? 'warning' : 'success') ?>" role="alert">
      <strong>
        ...
        <?php if ($listPasosVideos != null && $listPasosVideos[0]->strURL != null && $listPasosVideos[0]->strURL != '') {
          echo '<span style="float: right;cursor: pointer;" onClick="fnPasosMostrarVideo('."'".$listPasosVideos[0]->strURL."'".');"><i class="fa fa-video-camera" aria-hidden="true"></i> Ayuda</span>';
        } ?>
    </div>
    ...
    <div class="alert alert-<?php echo ($gDataPaso_2 == null ? 'warning' : 'success') ?>" role="alert">
      <strong>
        ...
        <?php if ($listPasosVideos != null && $listPasosVideos[1]->strURL != null && $listPasosVideos[1]->strURL != '') {
          echo '<span style="float: right;cursor: pointer;" onClick="fnPasosMostrarVideo('."'".$listPasosVideos[1]->strURL."'".');"><i class="fa fa-video-camera" aria-hidden="true"></i> Ayuda</span>';
        } ?>
    </div>
    ...
    <div class="alert alert-<?php echo ($gDataPaso_3 == null ? 'warning' : 'success') ?>" role="alert">
      <strong>
        ...
        <?php if ($listPasosVideos != null && $listPasosVideos[2]->strURL != null && $listPasosVideos[2]->strURL != '') {
          echo '<span style="float: right;cursor: pointer;" onClick="fnPasosMostrarVideo('."'".$listPasosVideos[2]->strURL."'".');"><i class="fa fa-video-camera" aria-hidden="true"></i> Ayuda</span>';
        } ?>
    </div>
    ...
    <div class="alert alert-info" role="alert">
      <strong>
        ...
        <?php if ($listPasosVideos != null && $listPasosVideos[3]->strURL != null && $listPasosVideos[3]->strURL != '') {
          echo '<span style="float: right;cursor: pointer;" onClick="fnPasosMostrarVideo('."'".$listPasosVideos[3]->strURL."'".');"><i class="fa fa-video-camera" aria-hidden="true"></i> Ayuda</span>';
        } ?>
    </div>
    <div class="alert alert-info" role="alert">
      <strong>
        ...
        <?php if ($listPasosVideos != null && $listPasosVideos[4]->strURL != null && $listPasosVideos[4]->strURL != '') {
          echo '<span style="float: right;cursor: pointer;" onClick="fnPasosMostrarVideo('."'".$listPasosVideos[4]->strURL."'".');"><i class="fa fa-video-camera" aria-hidden="true"></i> Ayuda</span>';
        } ?>
    </div>
    <div class="alert alert-info" role="alert">
      <strong>
        ...
        <?php if ($listPasosVideos != null && $listPasosVideos[5]->strURL != null && $listPasosVideos[5]->strURL != '') {
          echo '<span style="float: right;cursor: pointer;" onClick="fnPasosMostrarVideo('."'".$listPasosVideos[5]->strURL."'".');"><i class="fa fa-video-camera" aria-hidden="true"></i> Ayuda</span>';
        } ?>
    </div>
    <div class="alert alert-info" role="alert">
      <strong>
        ...
        <?php if ($listPasosVideos != null && $listPasosVideos[6]->strURL != null && $listPasosVideos[6]->strURL != '') {
          echo '<span style="float: right;cursor: pointer;" onClick="fnPasosMostrarVideo('."'".$listPasosVideos[6]->strURL."'".');"><i class="fa fa-video-camera" aria-hidden="true"></i> Ayuda</span>';
        } ?>
    </div>
  </div>
</div>
